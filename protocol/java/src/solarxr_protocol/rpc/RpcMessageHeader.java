  ...
  public void unpackTo(RpcMessageHeaderT _o) {
    ...
    switch (_oMessageType) {
      ...
      case solarxr_protocol.rpc.RpcMessage.OpenUriResponse:
        ...
        break;
      case solarxr_protocol.rpc.RpcMessage.StepMountingStatusResponse:
        _oMessageValue = message(new solarxr_protocol.rpc.StepMountingStatusResponse());
        _oMessage.setValue(_oMessageValue != null ? ((solarxr_protocol.rpc.StepMountingStatusResponse) _oMessageValue).unpack() : null);
        break;
      default: break;
    }
